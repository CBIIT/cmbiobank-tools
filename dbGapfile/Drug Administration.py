...
output=open("5a_TargetedTherapyAdministration.txt",'w')
...
for i in interfh:
    if i[0].startswith("projectid"):
        ...
        if i[RecordActive]=='0':
            ...
            hh=[i[RecordId],i[TX_CYCLE_NUM],i[CMSTDAT],i[CMENDAT],i[CMTRT_DSL],i[dos],i[unit],i[frm],i[CMDOSFRQ],i[rout],i[dur],i[cmc]]
