...
output=open("5a_TargetedTherapyInitiation.txt",'w')
...
for i in interfh:
    if i[0].startswith("projectid"):
        ...
        if i[RecordActive]=='0':
            ...
            hh=[i[RecordId],i[TX_CYCLE_NUM],i[INTVN_BEG_DT],i[MALG_NEO_ANTM_TP],i[WEIGHT_VSORRES],i[WUN],i[HEIGHT_VSORRES],i[hun],i[BSA_VSORRES]]
