...
for line in revfh:
    if line[0].startswith("projectid"):
        ...
        if line[RecordActive]=='0':
            ...
            if "Frozen" in line[InstanceName] or "Slide" in line[InstanceName] or "FFPE" in line[InstanceName]or "Bone Marrow Aspirate" in line[InstanceName] or "Formalin Bone Marrow Biopsy" in line[InstanceName]:
