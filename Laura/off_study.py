...
supp=open("HistologyOutput.txt",'r')
...
for value in suppfh:
    ...
    if value[0] in offList:
        ...
        if "Key" in value[0]:
            oncores.write("\t".join(value) + "\t" + "Off Study Date "+"\t"+"Reason for off-study"+"\t"+"If other specify- Reason for off study"+"\t"+"Best Overall Response"+"\n")
        else:
